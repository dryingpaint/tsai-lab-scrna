...
cell_bender_merged <- Read_CellBender_h5_Multi_Directory(base_path = "/Users/melissadu/projects/tsai-lab-scrna/data/output_10k/base/",
...
saveRDS(cell_bender_seurat, '/Users/melissadu/projects/tsai-lab-scrna/data/cellbender_filtered_merged_objects.rds')
```

```{r}
cell_bender_seurat <- readRDS( '/Users/melissadu/projects/tsai-lab-scrna/data/cellbender_filtered_merged_objects.rds')
...
saveRDS(merged_joinend, "/Users/melissadu/projects/tsai-lab-scrna/data/S1_cellbender_singlets_merged_qc.rds")
```



```{r qc, fig.width = 6, fig.height=4}
merged_joinend <- readRDS("/Users/melissadu/projects/tsai-lab-scrna/data/S1_cellbender_singlets_merged_qc.rds")
...
saveRDS(apoe4_obj_sketch,'/Users/melissadu/projects/tsai-lab-scrna/data/Annotated_cellbender_singlets_merged_qc.rds')

apoe4_obj_sketch <- readRDS('/Users/melissadu/projects/tsai-lab-scrna/data/Annotated_cellbender_singlets_merged_qc.rds')
